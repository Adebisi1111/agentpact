...
const CONTRACT = '0xA48cB03fa231F3c3D5BE735d4e40cDDD4054E4CA';
...
async function main() {
  ...
  // Create agreement with small escrow
  console.log('\n--- Creating Agreement ---');
  try {
    const tx = await client.writeContract({
      ...
      args: [
        ...
        'Test service agreement for monitoring',
      ...
      value: 100000000000000000n, // 0.1 GEN total escrow
    });
